(function() {
    ...
    myForm.addEventListener('submit', function(event) {
        ...
        if (ilindex>inputList.length)
        {
            ...
            madlib.innerHTML+= `<p>Let me tell you the story of <b>${wordList[0]}</b> the fearless <br/>
            ...
            Well, I wish, <b>${wordList[1]}</b> later succumbed to hayfever</p><button id="close">bruh</button>`;
