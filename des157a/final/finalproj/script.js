(function() {
    ...
    const footTag = document.querySelector('footer');
    ...
    const lBar = document.getElementById('myBar');
    var width = 0;
    ...
    convoBtn.addEventListener('click',function(){
       if (cindex<convoList.length) 
        ...
        if (convoList[cindex] === convoList[5]) {
            ...
            <input type="submit" value="Done" id="okay">
            </form>`;
    ...
    myForm.addEventListener('submit', function(event) {
        ...
        {
            footTag.style.visibility = "hidden";
            myForm.style.visibility = "hidden";
            madlib.style.visibility = "visible";
            madlib.style.animation = "pop-in 1.5s forwards";
            ...
            Unperturbed, <b>${wordList[0]}</b> left towards his lair at the shout of the human clock</p><p>'Twas a glorious battle, of blood, sweat and tears <br/>
            Brandishing the holy <b>${wordList[2]}</b>, amidst their companions' cheers
            </p><p>In a fit of rage, <b>${wordList[1]}</b> attacked <b>${wordList[3]}</b>, <b>${wordList[0]}</b>'s closest companion <br/>
            A last-ditch attempt to get back at the paladin, nearly sending their companion to oblivion</p><p>But <b>${wordList[0]}</b> intervened just in the nick of time,<br/>
            And the attack to finish <b>${wordList[2]}</b> was just sublime</p><p>The paladin changed their name to Julius Caeser <br/>
    ...
    function resetMadlibs() {
        ...
        footTag.style.visibility = "visible";
